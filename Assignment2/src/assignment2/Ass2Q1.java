...
public class Ass2Q1 extends JFrame {
    ...
    newPanel() {
      ...
      this.addKeyListener(new KeyAdapter() {
        public void keyPressed(KeyEvent e) {
          switch (e.getKeyCode()) {
            case KeyEvent.VK_DOWN: {delay += 10; System.out.println("Delay increased");} break;
            case KeyEvent.VK_UP: {delay -= 10; System.out.println("Delay decreased");} break;
            case KeyEvent.VK_S: {timer.stop(); System.out.println("Animation stopped");} break;
            case KeyEvent.VK_R: {timer.start(); System.out.println("Animation resumed");}break;
          }
