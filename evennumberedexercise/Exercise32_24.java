...
public class Exercise32_24 extends JApplet {
  ...
  public Exercise32_24() {
    add(chessBoard, BorderLayout.CENTER);
    add(new JLabel("Click the mouse to see the next move", JLabel.CENTER), BorderLayout.SOUTH);
  ...
  public static void main(String[] args) {
    ...
    Exercise32_24 applet = new Exercise32_24();
