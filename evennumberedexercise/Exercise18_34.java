...
public class Exercise18_34 extends JApplet {
        ...
        public void mousePressed(MouseEvent e) {
          ...
          if (available()) {
            ...
            if (result != null) {
          	...
          	if (isDraw()) {            		
          		JOptionPane.showMessageDialog(null, "A draw, no winner, start over");
          		startOver();
          	}
  ...
  /** Return null if no consecutive four; 
   * otherwise, return the locations of the four consecutive cells.
   * The locations are in (result[0][0], result[0][1]), (result[1][0], result[1][1]),
   * (result[2][0], result[2][1]), and (result[3][0], result[3][1]) */
