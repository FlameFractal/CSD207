...
public class Exercise33_06Client extends JFrame implements ActionListener {
  ...
  public static void main(String[] args) {
    Exercise33_06Client frame = new Exercise33_06Client();
    frame.pack();
    frame.setTitle("Exercise33_06Client");
