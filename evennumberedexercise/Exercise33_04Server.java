// Exercise33_04Server.java: Web visit count server
import java.io.*;
import java.net.*;
import java.awt.*;
...
public class Exercise33_04Server extends JFrame implements ActionListener {
  ...
  public Exercise33_04Server() {
    ...
    setTitle("Exercise33_04Server: Web Visit Count Server");
    setSize(300, 300);
  ...
  public static void main(String args[]) {
    Exercise33_04Server frame = new Exercise33_04Server();
  }
