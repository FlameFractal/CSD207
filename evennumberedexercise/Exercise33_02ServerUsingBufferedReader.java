// Exercise33_02ServerUsingBufferedReader.java
import java.io.*;
import java.net.*;
import java.util.*;
import java.awt.*;
...
public class Exercise33_02ServerUsingBufferedReader extends JFrame {
  private JTextArea jta = new JTextArea();

  public static void main(String[] args) {
    new Exercise33_02ServerUsingBufferedReader();
  }

  public Exercise33_02ServerUsingBufferedReader() {
    // Place text area on the frame
    setLayout(new BorderLayout());
    add(new JScrollPane(jta), BorderLayout.CENTER);

    // It is necessary to show the frame here!
    setTitle("Exercise33_02ServerUsingBufferedReader");
