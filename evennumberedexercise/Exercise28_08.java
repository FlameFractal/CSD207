...
public class Exercise28_08 extends JApplet {
  private MyHashMap<Integer, Integer> map 
    = new MyHashMap<Integer, Integer>(11);
  ...
  private JTextField jtfInitialTableSize = new JTextField(2);
  private JTextField jtfSearchValue = new JTextField(2);
  
  public Exercise28_08() {    
    JPanel panel = new JPanel();
    panel.add(new JLabel("Enter initial table size: "));
    panel.add(jtfInitialTableSize);
    panel.add(new JLabel("Enter a value: "));
    panel.add(jtfNumber);
    panel.add(jbtInsert);
    panel.add(jbtDelete);
    panel.add(jbtRemoveAll);
    panel.add(new JLabel("Search a key: "));
    panel.add(jtfSearchValue);
      ...
      public void actionPerformed(ActionEvent e) {
      	try {
	        ...
	        view.repaint();
      		...
      		JOptionPane.showMessageDialog(null, "Incorrect number in the text field");      		
      	}
      }
    });
    ...
    jtfInitialTableSize.addActionListener(new ActionListener() {
      @Override 
      public void actionPerformed(ActionEvent e) {
      	try {
	        map = new MyHashMap<Integer, Integer>(Integer.parseInt(jtfInitialTableSize.getText()));;
	        view.repaint();
      	}
      	catch (NumberFormatException ex) {
      		JOptionPane.showMessageDialog(null, "Incorrect number in the text field");
    ...
    jtfSearchValue.addActionListener(new ActionListener() {
      @Override 
      public void actionPerformed(ActionEvent e) {
      	try {
      		int key = Integer.parseInt(jtfSearchValue.getText());
      		
	        if (map.containsKey(key))
	        	JOptionPane.showMessageDialog(null, key + " is in the table");
	        else
	        	JOptionPane.showMessageDialog(null, key + " is not in the table");
  ...
  public static void main(String[] args) {
    ...
    frame.add(new Exercise28_08());
    frame.setTitle("Exercise28_08");
    frame.setSize(670, 430);
