...
public class Exercise20_36 extends JApplet {
  private JTextField jtfOrder = new JTextField("0", 5); // Order
  private HilbertCurve hilerbtCurvePanel = 
    new HilbertCurve(); // To display the pattern
  
  public Exercise20_36() {
  ...
  public static void main(String[] args) {
    JApplet applet = new Exercise20_36();
    applet.init();
    applet.start();
