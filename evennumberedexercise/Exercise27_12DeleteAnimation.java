...
public class Exercise27_12DeleteAnimation extends JApplet {
  ...
  public Exercise27_12DeleteAnimation() {
    tree.insert(50);
/*    tree.insert(25);
    tree.insert(75);
    tree.insert(12);
  ...
  public static void main(String[] args) {
    JFrame frame = new JFrame("Exercise25_12DeleteAnimation");
    JApplet applet = new Exercise27_12DeleteAnimation();
    frame.add(applet);
