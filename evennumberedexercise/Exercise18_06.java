...
public class Exercise18_06 extends JApplet {
  ...
  public static void main(String[] args) {
    // Create a frame
    JFrame frame = new JFrame("Exercise18_06");

    // Create an instance of the applet
    Exercise18_06 applet = new Exercise18_06();
...
class Cell extends JPanel implements MouseListener {
  ...
  // Reference to parent
  Exercise18_06 parent;

  public Cell(Exercise18_06 parent) {
    this.parent = parent;
