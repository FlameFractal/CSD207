// Exercise33_02ClientUsingBufferedReader.java
import java.io.*;
import java.net.*;
import java.util.*;
import java.awt.*;
...
public class Exercise33_02ClientUsingBufferedReader extends JFrame implements ActionListener {
  ...
  public static void main(String[] args) {
    new Exercise33_02ClientUsingBufferedReader();
  }

  public Exercise33_02ClientUsingBufferedReader() {
    Panel p1 = new Panel();
    p1.add(new Label("Enter radius"));
    p1.add(jtf = new JTextField(10));

    // It is necessary to show the frame here!
    setTitle("Exercise33_02ClientUsingBufferedReader");
    setSize(500, 300);
