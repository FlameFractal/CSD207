...
public class Exercise39_12 extends JApplet {
  ...
  public Exercise39_12() {
    add(jcboColor, BorderLayout.NORTH);
    add(jlbl, BorderLayout.CENTER);

    jcboColor.setRenderer(new Exercise39_12CellRenderer());
  ...
  public static void main(String[] args) {
    Exercise39_12 applet = new Exercise39_12();
    JFrame frame = new JFrame();
    frame.setTitle("Exercise39_12");
